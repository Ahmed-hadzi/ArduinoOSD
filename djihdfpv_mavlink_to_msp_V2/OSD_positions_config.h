...
const uint16_t osd_rssi_value_pos = 2177;
...
const uint16_t osd_current_draw_pos = 2359;
const uint16_t osd_mah_drawn_pos = 2393;
uint16_t osd_gps_sats_pos = 234;
const uint16_t osd_main_batt_voltage_pos = 2329;
const uint16_t osd_pitch_angle_pos = 2281;
const uint16_t osd_roll_angle_pos = 2345;
